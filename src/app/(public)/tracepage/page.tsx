...
export default function TraceSection() {
  ...
  return (
    <section id="tracepage" className="relative py-16 pt-34 bg-gradient-to-br from-[#fff8f2] via-white to-[#ffe8d6] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Palm Leaf Shadows */}
        <motion.div
          className="absolute top-10 left-5 opacity-4"
          animate={{
            y: [0, -12, 0],
            rotate: [0, 2, 0],
          }}
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <div className="flex gap-2 justify-center flex-wrap">
            <motion.span 
            className="inline-flex items-center gap-2 px-4 py-2 bg-[#2f7a32]/10 text-[#2f7a32] rounded-full text-xs font-semibold mb-4 backdrop-blur-sm border border-[#2f7a32]/20"
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition={{ delay: 0.2, type: "spring" }}
            viewport={{ once: true, margin: "-50px" }}
          >
            <div className="w-1.5 h-1.5 bg-[#2f7a32] rounded-full animate-pulse" />
            Unadulterated
          </motion.span>
          <motion.span 
            className="inline-flex items-center gap-2 px-4 py-2 bg-[#2f7a32]/10 text-[#2f7a32] rounded-full text-xs font-semibold mb-4 backdrop-blur-sm border border-[#2f7a32]/20"
