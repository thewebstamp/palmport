...
export default function ContactSection() {
  ...
  const contactMethods = [
    {
      ...
      value: "palmportng@gmail.com",
      link: "mailto:palmportng@gmail.com"
    },
    {
      icon: "📞",
      title: "Call Us",
  ...
  return (
    <section id="contactpage" className="py-20 pt-34 bg-gradient-to-br from-white via-[#fff8f2] to-[#ffe8d6] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-[#5c3b28] mb-6">
            Let's Start <span className="text-[#d75639]">A Conversation</span>
          </h2>
